...
export const ActionDescriptions: Record<string, { tr: string; icon: string }> = {
  ...
  CREATE_NEARMISS: { tr: 'Ramakkala Raporu Oluşturuldu', icon: '⚠️' },
  UPDATE_NEARMISS: { tr: 'Ramakkala Raporu Güncellendi', icon: '✏️' },
  DELETE_NEARMISS: { tr: 'Ramakkala Raporu Silindi', icon: '🗑️' },
